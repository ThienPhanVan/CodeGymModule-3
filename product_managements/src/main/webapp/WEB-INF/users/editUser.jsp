                    ...
                    <div class="col-12">
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <a href="${pageContext.request.contextPath}/user" class="btn btn-outline-primary">LIST USERS</a>
                            </div>
                    ...
                    <div class="col-sm-12">
                        ...
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="name" name="fullName" class="form-control" value="${user.getFullName()}" />
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="text" id="age" name="age" class="form-control" value="${user.getAge()}" />
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input type="password" id="passwordUser" name="passwordUser" value="${user.getPasswordUser()}" class="form-control" />
                                </div>
                            </div>
