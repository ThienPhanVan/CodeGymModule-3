...
<%--                        <img alt="user-image" class="mr-2" height="12"> <span--%>
...
<%--                </li>--%>
            ...
            <!-- LOGO -->
            <div class="logo-box">
                <a href="http://localhost:8080/product" class="logo text-center">
                                    <span class="logo-lg">
                                        <img src="https://d1lss44hh2trtw.cloudfront.net/assets/article/2019/08/29/apple-reverses-stance-on-selling-parts-to-independent-shops_feature.jpg" alt="" height="63">
                                         <span class="logo-lg-text-light">IPHONE</span>
                                    </span>
                    <span class="logo-sm">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
                ...
                <li class="d-none d-sm-block">
                    <form action="/product" class="app-search">
            ...
            <div id="navigation">
                ...
                <ul class="navigation-menu">
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href="http://localhost:8080/user">User</a></li>
                            <li><a href="/product?action=create">Create</a></li>
                        </ul>
                    </li>
